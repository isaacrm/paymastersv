    ...
    <div class="q-pa-md">
      <q-card class="my-card">
        <q-card-section class="ml-6">
          ...
          <div class="text-subtitle">Registro de las empresas.</div>
        </q-card-section>
        <q-card-section>
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              <q-item>
                <q-input
                  ...
                  :error-message="errores.telefono && errores.telefono[0]"
            ...
            <div class="col-12 col-md-4">
              <q-item>
                <q-input
                  ...
                  class="full-width"
                  label="Número de NRC"
                  :error-message="errores.nrc && errores.nrc[0]"
            ...
            <div class="col-12 col-md-4">
              <q-item>
                <q-input
                  ...
                  class="full-width"
                  label="Sitio web"
                  :error-message="errores.sitio_web && errores.sitio_web[0]"
            ...
            <div class="col-12 col-md-6">
              <q-item>
                <q-input
                  ...
                  :error-message="
                    errores.numero_patronal && errores.numero_patronal[0]
                  "
